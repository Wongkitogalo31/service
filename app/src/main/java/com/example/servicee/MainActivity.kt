...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_facebook.setOnClickListener({
            val i = Intent (Intent.ACTION_VIEW, Uri.parse("http://www.facebook.com/agungsetiawan"))
            startActivity(i)
        })
        ...
        btn_instagram.setOnClickListener({
            val i = Intent (Intent.ACTION_VIEW, Uri.parse("http://www.instagram.com/agungsetiawan5248_"))
            startActivity(i)
        })

        //Mendeklarasikan Variabel MediaPlayer memanggil data mp3
        var MediaPlayer: MediaPlayer? = MediaPlayer.create(this,R.raw.agung)
